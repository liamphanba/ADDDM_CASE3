...
We exclude Images 8, 9, 11 and 15 from EFA and CFA processes. We can check their actually sentences to see if there is any logical reasons of those processes to have behave that way. 
