...
Corr_Values <- round(cor(df_1), 1)

# P-Value
p.mat <- cor_pmat(df_1)

# Correlation Plot
ggcorrplot(Corr_Values, hc.order = TRUE, type = "lower", lab = TRUE, p.mat = p.mat, sig.level=0.05, lab_size = 2, tl.cex = 10,outline.col = "white", ggtheme = ggplot2::theme_minimal(), colors = c("#308259", "white", "#823038")) 
...
Correlation matrix seems alright (Michael)
