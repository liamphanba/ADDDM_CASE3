---
title: "**Case Study 3 - Galleries Lafayette**"
...
The Model is very good when looking at the criterion for model fitting.
...
The Model fitting criterions are all better than the previous CFA model with the previous images. Lower AIC and BIC as well as RMSEA indicate better fitting.
...
There is **4** mediations from **Affective Commitment to Repurchase Intention** and \***4** mediations **from Affective Commitment to Co-creation Intention.**

There is **3** mediations from **Consumer Satisfaction to Repurchase Intention** and 2 mediations from **Consumer Satisfaction to Co-creation**
...
[A Brief History of French Cuisine](https://www.ecpi.edu/blog/a-brief-history-of-french-cuisine#:~:text=The%20Advent%20of%20Haute%20Cuisine,first%20%22true%20French%20cookbook%22.)
...
[Haute couture](https://en.wikipedia.org/wiki/Haute_couture)
...
There is overall a very small impact from the indirect effects. Therefore we can already see that **Affective Commitment** is more represented than **Consumer Satisfaction** (8 times versus 5 times) Mediator. There is also very equivalent outcomes for both of those mediators.
...
The positive drivers for **Repurchase Intention** and **Co-creation Intention** are the following dimensions:

<center>**Shopping Experience (Total Effect) \| French Culture (Indirect Effect) \| Product Assortment (Indirect Effect)**</center>

And the negative drivers are:

<center>**Store Decoration (Indirect Effect) \| Luxury Brands (Indirect Effect)**</center>

Ambiguous drivers are:

<center>

**Professionalism (Indirect Effect)**

Ambiguous since drives down **Co-creation** , but positively affects **Repurchase Intention**.
...
|:----------------:|:----------------:|:----------------:|:-----------------:|
| Shopping Experience | Im20, Im21, Im22 |    0.341     | Co-creation Intention |
...
|:----------------:|:----------------:|:----------------:|:----------------:|
| Shopping Experience | Affective Commitment  |         0.202         | Co-creation Intention |
| Shopping Experience | Affective Commitment  |         0.069         | Repurchase Intention  |
|   French Culture    | Affective Commitment  |         0.120         | Co-creation Intention |
|   French Culture    | Affective Commitment  |         0.041         | Repurchase Intention  |
|   Professionalism   | Consumer Satisfaction |        -0.165         | Co-creation Intention |
|   Professionalism   | Consumer Satisfaction |         0.098         | Repurchase Intention  |
|    Luxury Brands    | Affective Commitment  |        -0.091         | Co-creation Intention |
|    Luxury Brands    | Affective Commitment  |        -0.031         | Repurchase Intention  |
|  Store Decoration   | Consumer Satisfaction |        -0.023         | Repurchase Intention  |
| Product Assortment  |        CS + AC        | 0.028 + 0.020 = 0.048 | Repurchase_Intention  |
| Product Assortment  |        CS + AC        | 0.057 - 0.048 = 0.009 | Co-creation Intention |

------------------------------------------------------------------------

<center>This table contains standardized coefficients\*</center>

**Interpretations**

Since the Total Effect (standardized) of **Shopping Experience** is the main driver for increasing up the **Repurchase Intention** and **Co-creation**, this dimension in **Galleries Lafayette** should be more analyzed to get more detailed insights on how Consumer would behave with changes in this dimension.
