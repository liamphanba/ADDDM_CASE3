...
[](https://quantpsy.org/pubs/preacher_zhang_kim_mels_2013.pdf)
...
fa.diagram(fa_result8, sort = TRUE, adj = 1, rsize = 4, e.size = 0.07, main = "Factors Analysis with 8 factors", digits = 2, l.cex = 1)
